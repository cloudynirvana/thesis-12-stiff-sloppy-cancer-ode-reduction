...
<head>
<meta charset="utf-8"/>
<title>Thesis #12. Stiff-sloppy spectra of a cancer-state ODE</title>
<style>
@page {{
  size: A4;
  margin: 22mm 20mm 24mm 20mm;
  @bottom-center {{
    content: "Ogbonna KE. Thesis #12. Computational research only. Not a medical device. " counter(page);
    font-size: 8.5pt;
    color: #444;
